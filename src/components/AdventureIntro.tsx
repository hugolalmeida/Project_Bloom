    ...
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-[#071833]/80 px-4 py-6 backdrop-blur-sm">
      <section className="relative w-full max-w-md overflow-hidden rounded-[32px] border border-[#8fb5ff] bg-[#f8fbff] p-5 text-center shadow-[0_24px_70px_rgba(7,24,51,0.36)]">
        ...
        <div className="pointer-events-none absolute inset-0 opacity-70">
          <span className="absolute left-8 top-10 h-3 w-3 animaté-adventure-spark rounded-full bg-[#f0a83a]" />
          <span className="absolute right-10 top-20 h-2 w-2 animaté-adventure-spark rounded-full bg-[#8fb5ff] [animation-delay:160ms]" />
          <span className="absolute bottom-24 left-12 h-2 w-2 animaté-adventure-spark rounded-full bg-[#5cbf7a] [animation-delay:300ms]" />
        </div>

        <div className="relative">
          <div className="mx-auto mb-4 flex h-24 w-24 animaté-adventure-pop items-center justify-center rounded-[28px] bg-[#dce8ff] text-5xl shadow-[inset_0_-8px_0_rgba(31,95,191,0.12)]">
            🧭
          </div>
          ...
          <h2 className="mt-2 text-3xl font-black leading-tight text-[#102b55]">
            Sua aventura começa agora, {characterName}!
          </h2>
          <p className="mx-auto mt-3 max-w-sm text-sm font-semibold leading-6 text-[#4b638f]">
            Pequenas missões diárias vao fortalecer seu personagem. Ore, estude, sirva e avance um
            dia por vez.
          </p>
          ...
          <div className="my-5 rounded-[24px] bg-white p-4 text-left shadow-[0_12px_26px_rgba(17,49,96,0.1)]">
            ...
            <p className="mt-1 text-base font-black text-[#102b55]">
              Complete as metas de hoje para ganhar XP e iniciar sua sequência.
            </p>
          </div>
          ...
          <button
            ...
            type="button"
          >
            {saving ? "Abrindo caminho..." : "Começar aventura"}
          </button>
        </div>
      </section>
    </div>
